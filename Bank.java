...
public class Bank {
	...
	public boolean createAccount(AccountsDto accounts) throws Exception {
	...
	public AccountsDto getAccountById(int accountId) throws Exception {
	...
	public AccountsDto getAccountByName(String accountHolderName) throws Exception {
		AccountsDto account=null;
	...
	public AccountsDto getAccountByType(String accountType) throws Exception{
		AccountsDto account=null;
		 System.out.println("inside getAccountById() ");
		   if(accountType!=null) {
			   for(int i=0;i<accounts.length;i++) {
	...
	public boolean updateAccountTypebyId(String accountType,int accountId) throws Exception {
	...
	public boolean deleteAccountbyName(String accountHolderName) throws Exception{
