...
public class Google {
	...
	public boolean createGoogleApplication(GoogleApplicationDto apps) {
	...
	public GoogleApplicationDto getGoogleApplicationById(int appId) {
	...
	public boolean updateGoogleApplicationNameById(String appName,int appId) {
	...
	public boolean deleteAppByName(String appName) {
