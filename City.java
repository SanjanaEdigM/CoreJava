...
public class City {
	...
	public boolean createCompany(CompanyDto companys) throws Exception {
	...
	public boolean updateCompanyNameById(String companyName,int companyId)  throws Exception{
