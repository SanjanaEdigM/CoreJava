...
public class Shop {
	...
	public boolean createGadget(ElectronicGadgetsDto gadgets) throws Exception {
	...
	public ElectronicGadgetsDto getGadgetByName(String gadgetName) throws Exception {
	...
	public ElectronicGadgetsDto getGadgetById(int gadgetId) throws Exception {
		ElectronicGadgetsDto gadget=null;
		System.out.println("Inside Get Gadget by its ID");
		if (gadgetId!=0) {
		 for(int i=0;i<gadgets.length;i++){
	...
	public boolean updateNameByGadgetPrice(String gadgetName,double gadgetPrice) throws Exception {
	 ...
	 public boolean deleteGadgetById(int id) throws Exception{
